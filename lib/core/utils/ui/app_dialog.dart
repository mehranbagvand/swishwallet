      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text("We are implementing this section, please be patient".tr, style: const TextStyle(fontSize: 10)),
            const SizedBox(height: 15),
            // ButtonCustom("back".tr, onClick: ()=>closeDialog(), width: 110, colorMain: const Color(0xffFF725E)),
          ],
        ),
      ),
    ));
